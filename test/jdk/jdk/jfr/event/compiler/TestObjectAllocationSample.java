...
public class TestObjectAllocationSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        rate.enable(EVENT_NAME).with("throttle", "100/m");
        rate.start();
        Recording probability = new Recording();
        probability.enable(EVENT_NAME).with("throttle", "200/s");
        probability.start();
        Recording nthSelection = new Recording();
        nthSelection.enable(EVENT_NAME).with("throttle", "2th");
        nthSelection.start();
        ...
        int countEvents = 0;
        for (RecordedEvent event : Events.fromRecording(nthSelection)) {
